...
public class TestAssoOneToOne {
    ...
    void test_delete(){
        ...
        org.junit.jupiter.api.Assertions.assertNull(employeDB);
        org.junit.jupiter.api.Assertions.assertNull(adresseDB);
    }
